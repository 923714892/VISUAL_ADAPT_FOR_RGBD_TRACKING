...
#              /
#
# who are you ? My experience zhang dian le. I am very happy !
...
class ViPTTrack(BaseTracker):
    def __init__(self, params):
        ...
        checkpoint = '/media/zbn/data/zgt/CVPR2024/ViPT-main/ViPT-main/output/checkpoints/train/vipt/deep_rgbd/ViPTrack_ep0060.pth.tar'
